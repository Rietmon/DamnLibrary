...
public class InputManager : UnityBehaviour
{
    ...
    private static void UpdateKeysArray(List<KeyCode> array, Dictionary<KeyCode, List<Action<KeyCode>>> callbacks, Func<KeyCode, bool> func)
    {
        array.Clear();
    ...
    public static void RegisterOnKeyDownAndOnKeyUpCallback(KeyCode keyCode, Action<KeyCode> downCallback, Action<KeyCode> upCallback)
    {
        RegisterCallback(onKeyDownCallbacks, keyCode, downCallback);
        RegisterCallback(onKeyUpCallbacks, keyCode, upCallback);
    }
    
    public static void UnregisterOnKeyDownAndOnKeyUpCallback(KeyCode keyCode, Action<KeyCode> downCallback, Action<KeyCode> upCallback)
    {
